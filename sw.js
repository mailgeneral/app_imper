...
// Evento 'message': escucha los mensajes de la app.
// Si recibe 'SKIP_WAITING', se activará inmediatamente.
self.addEventListener('message', event => {
  if (event.data && event.data.type === 'SKIP_WAITING') {
    console.log('Service Worker: Omitiendo espera y activando...');
    self.skipWaiting();
  }
});
